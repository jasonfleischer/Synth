...
uglifyjs js/prototypes.js js/model.js js/storage.js js/oscillator.js js/note.js js/alert.js js/keyboard_shortcuts.js js/window_resize.js js/information.js js/main.js js/install.js service_worker.js -o js/bundle.js
