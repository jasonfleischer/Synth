...
function init() {
	...
	function setupHarmonicsTable() {
		...
		for (i = 0; i < harmonicsVolume.length; i++) {
			...
			innerTableHtml += "<tr><td style='width:150px' id='harmonic_text_"+i+"' >H"+i+"</td><td><input type='range' min='0' max='100' value='"+percentValue+"' step='0.001' class='slider' style='width:400px;' id='harmonic_"+i+"' /></td></tr>";
